...
<body>
    <?php
        ...
        include_once($_SESSION["directorio"].'/src/modulos/ModulosWeb/ModuloProyectos/LineasBase/InformesFichero/util_lineas_base_informes_fichero.php');
        ...
        $parametros_informe = array(
            "id_linea_base" => $_GET["id_linea_base"],
        ...
        $contenido_informe_fichero = "
            <div id='contenedor-informe-fichero-simulador-linea-base' class='container contenedor-informe-fichero'>
                <div id='contenido-informe-fichero-simulador-linea-base'>";
        $paginas_informe_fichero = "";

        // Página de parámetros
        $paginas_informe_fichero .= "
            <div class='pagina-informe-fichero' id='pagina-parametros-informe-fichero-simulador-linea-base'>";
        $paginas_informe_fichero .= dame_html_cabecera_informe_fichero_proyectos_lineas_base(TIPO_INFORME_PROYECTOS_SIMULADOR_LINEA_BASE);
        $paginas_informe_fichero .= dame_html_parametros_tipo_informe_fichero_proyectos_simulador_linea_base($parametros_informe);
        $paginas_informe_fichero .= "
                <div class='mensaje-aviso-informe-fichero' id='mensaje-aviso-informe-fichero-simulador-linea-base'></div>
                <div class='fin-pagina-informe-fichero'></div>
            </div>";

        // Páginas del informe
        $paginas_informe_fichero .= dame_html_informe_tipo_proyectos_simulador_linea_base(TIPO_INFORME_FICHERO);
...
<script class="code" type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        proyectos_simulador_linea_base_ver_informe_fichero();
    });
</script>
