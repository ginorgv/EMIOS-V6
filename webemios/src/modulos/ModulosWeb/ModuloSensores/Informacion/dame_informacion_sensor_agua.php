<?php
    ...
    AuditoriaAcciones::comprobar_registrar_accion(ACCION_OBTENER_INFORMACION_AGUA_SENSOR, $_POST);

    // Se recupera y devuelve la información de gas de un sensor
    $parametros = $_POST;
    $parametros["clase_sensor"] = CLASE_SENSOR_AGUA;
    $filas_valores_sensor = dame_filas_valores_sensor($parametros);
    $resultado = dame_informacion_sensor_agua($parametros, $filas_valores_sensor);
