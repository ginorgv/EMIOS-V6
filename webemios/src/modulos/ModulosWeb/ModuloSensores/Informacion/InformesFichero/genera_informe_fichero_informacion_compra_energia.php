...
<body>
    <?php
        ...
        $contenido_informe_fichero = "
            <div id='contenedor-informe-fichero-informacion-informacion-compra-energia' class='container contenedor-informe-fichero'>
                <div id='contenido-informe-fichero-informacion-compra-energia'>";
        $paginas_informe_fichero = "";

        // Página de parámetros
        $paginas_informe_fichero .= "
            <div class='pagina-informe-fichero' id='pagina-parametros-informe-fichero-informacion-compra-energia'>";
        $paginas_informe_fichero .= dame_html_cabecera_informe_fichero_sensores_informacion(TIPO_INFORME_SENSORES_INFORMACION_COMPRA_ENERGIA);
        $paginas_informe_fichero .= dame_html_parametros_tipo_informe_fichero_sensores_informacion_compra_energia($parametros_informe);
        $paginas_informe_fichero .= "
                <div class='mensaje-aviso-informe-fichero' id='mensaje-aviso-informe-fichero-informacion-compra-energia'></div>
                <div class='fin-pagina-informe-fichero'></div>
            </div>";

        // Páginas del informe
        $paginas_informe_fichero .= dame_html_informe_tipo_sensores_informacion(CLASE_SENSOR_COMPRA_ENERGIA, TIPO_INFORME_FICHERO);
...
<script class="code" type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        sensores_informacion_compra_energia_ver_informe_fichero();
    });
</script>
