...
<body>
    <?php
        ...
        $contenido_informe_fichero = "
            <div id='contenedor-informe-fichero-informacion-humedad' class='container contenedor-informe-fichero'>
                <div id='contenido-informe-fichero-informacion-humedad'>";
        $paginas_informe_fichero = "";

        // Página de parámetros
        $paginas_informe_fichero .= "
            <div class='pagina-informe-fichero' id='pagina-parametros-informe-fichero-informacion-humedad'>";
        $paginas_informe_fichero .= dame_html_cabecera_informe_fichero_sensores_informacion(TIPO_INFORME_SENSORES_INFORMACION_HUMEDAD);
        $paginas_informe_fichero .= dame_html_parametros_tipo_informe_fichero_sensores_informacion_humedad($parametros_informe);
        $paginas_informe_fichero .= "
                <div class='mensaje-aviso-informe-fichero' id='mensaje-aviso-informe-fichero-informacion-humedad'></div>
                <div class='fin-pagina-informe-fichero'></div>
            </div>";

        // Páginas del informe
        $paginas_informe_fichero .= dame_html_informe_tipo_sensores_informacion(CLASE_SENSOR_HUMEDAD, TIPO_INFORME_FICHERO);
...
<script class="code" type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        sensores_informacion_humedad_ver_informe_fichero();
    });
</script>
