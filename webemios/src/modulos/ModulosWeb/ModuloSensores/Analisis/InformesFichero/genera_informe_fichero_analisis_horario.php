...
<body>
    <?php
        ...
        $contenido_informe_fichero = "
            <div id='contenedor-informe-fichero-analisis-horario' class='container contenedor-informe-fichero'>
                <div id='contenido-informe-fichero-analisis-horario'>";
        $paginas_informe_fichero = "";

        // Página de parámetros
        $paginas_informe_fichero .= "
            <div class='pagina-informe-fichero' id='pagina-parametros-informe-fichero-analisis-horario'>";
        $paginas_informe_fichero .= dame_html_cabecera_informe_fichero_sensores_analisis(TIPO_INFORME_SENSORES_ANALISIS_HORARIO);
        $paginas_informe_fichero .= dame_html_parametros_tipo_informe_fichero_sensores_analisis_horario($parametros_informe);
        $paginas_informe_fichero .= "
                <div class='mensaje-aviso-informe-fichero' id='mensaje-aviso-informe-fichero-analisis-horario'></div>
                <div class='fin-pagina-informe-fichero'></div>
            </div>";

        // Páginas del informe
        $paginas_informe_fichero .= dame_html_informe_tipo_sensores_analisis_horario(TIPO_INFORME_FICHERO);
...
<script class="code" type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        sensores_analisis_horario_ver_informe_fichero();
    });
</script>
