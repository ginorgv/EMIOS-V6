...
<body>
    <?php
        ...
        $contenido_informe_fichero = "
            <div id='contenedor-informe-fichero-analisis-diario' class='container contenedor-informe-fichero'>
                <div id='contenido-informe-fichero-analisis-diario'>";
        $paginas_informe_fichero = "";

        // Página de parámetros
        $paginas_informe_fichero .= "
            <div class='pagina-informe-fichero' id='pagina-parametros-informe-fichero-analisis-diario'>";
        $paginas_informe_fichero .= dame_html_cabecera_informe_fichero_sensores_analisis(TIPO_INFORME_SENSORES_ANALISIS_DIARIO);
        $paginas_informe_fichero .= dame_html_parametros_tipo_informe_fichero_sensores_analisis_diario($parametros_informe);
        $paginas_informe_fichero .= "
                <div class='mensaje-aviso-informe-fichero' id='mensaje-aviso-informe-fichero-analisis-diario'></div>
                <div class='fin-pagina-informe-fichero'></div>
            </div>";

        // Páginas del informe
        $paginas_informe_fichero .= dame_html_informe_tipo_sensores_analisis_diario(TIPO_INFORME_FICHERO);
...
<script class="code" type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        sensores_analisis_diario_ver_informe_fichero();
    });
</script>
