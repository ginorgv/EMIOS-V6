...
<body>
    <?php
        ...
        $contenido_informe_fichero = "
            <div id='contenedor-informe-fichero-valores-generales' class='container contenedor-informe-fichero'>
                <div id='contenido-informe-fichero-valores-generales'>";
        $paginas_informe_fichero = "";

        // Página de parámetros
        $paginas_informe_fichero .= "
            <div class='pagina-informe-fichero' id='pagina-parametros-informe-fichero-valores-generales'>";
        $paginas_informe_fichero .= dame_html_cabecera_informe_fichero_sensores_comparacion(TIPO_INFORME_SENSORES_VALORES_GENERALES);
        $paginas_informe_fichero .= dame_html_parametros_tipo_informe_fichero_sensores_valores_generales($parametros_informe);
        $paginas_informe_fichero .= "
                <div class='mensaje-aviso-informe-fichero' id='mensaje-aviso-informe-fichero-valores-generales'></div>
                <div class='fin-pagina-informe-fichero'></div>
            </div>";

        // Páginas del informe
        $paginas_informe_fichero .= dame_html_informe_tipo_sensores_valores_generales(TIPO_INFORME_FICHERO);
...
<script class="code" type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        sensores_valores_generales_ver_informe_fichero();
    });
</script>
