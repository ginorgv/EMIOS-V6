...
<body>
    <?php
        ...
        $parametros_informe = array(
            ...
            "clases_sensores" => $_GET["clases_sensores"],
            "ids_sensores" => $_GET["ids_sensores"],
            "campos" => $_GET["campos"],
            "parametros_extra_campos" => $_GET["parametros_extra_campos"],
            "fecha_inicio" => $_GET["fecha_inicio"],
            "hora_inicio" => $_GET["hora_inicio"],
            "fecha_fin" => $_GET["fecha_fin"],
            "hora_fin" => $_GET["hora_fin"],
            "intervalo_valores" => $_GET["intervalo_valores"],
            "unificar_escalas" => $_GET["unificar_escalas"],
        ...
        $contenido_informe_fichero = "
            <div id='contenedor-informe-fichero-comparacion-campos-diferentes' class='container contenedor-informe-fichero'>
                <div id='contenido-informe-fichero-comparacion-campos-diferentes'>";
        $paginas_informe_fichero = "";

        // Página de parámetros
        $paginas_informe_fichero .= "
            <div class='pagina-informe-fichero' id='pagina-parametros-informe-fichero-comparacion-campos-diferentes'>";
        $paginas_informe_fichero .= dame_html_cabecera_informe_fichero_sensores_comparacion(TIPO_INFORME_SENSORES_COMPARACION_CAMPOS_DIFERENTES);
        $paginas_informe_fichero .= dame_html_parametros_tipo_informe_fichero_sensores_comparacion_campos_diferentes($parametros_informe);
        $paginas_informe_fichero .= "
                <div class='mensaje-aviso-informe-fichero' id='mensaje-aviso-informe-fichero-comparacion-campos-diferentes'></div>
                <div class='fin-pagina-informe-fichero'></div>
            </div>";

        // Páginas del informe
        $paginas_informe_fichero .= dame_html_informe_tipo_sensores_comparacion_campos_diferentes(TIPO_INFORME_FICHERO);
...
<script class="code" type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        sensores_comparacion_campos_diferentes_ver_informe_fichero();
    });
</script>
