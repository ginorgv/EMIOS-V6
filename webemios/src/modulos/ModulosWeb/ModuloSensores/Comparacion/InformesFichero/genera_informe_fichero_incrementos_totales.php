...
<body>
    <?php
        ...
        $parametros_informe = array(
            ...
            "clases_sensor" => $_GET["clases_sensor"],
            "campos" => $_GET["campos"],
        ...
        $contenido_informe_fichero = "
            <div id='contenedor-informe-fichero-incrementos-totales' class='container contenedor-informe-fichero'>
                <div id='contenido-informe-fichero-incrementos-totales'>";
        $paginas_informe_fichero = "";

        // Página de parámetros
        $paginas_informe_fichero .= "
            <div class='pagina-informe-fichero' id='pagina-parametros-informe-fichero-incrementos-totales'>";
        $paginas_informe_fichero .= dame_html_cabecera_informe_fichero_sensores_comparacion(TIPO_INFORME_SENSORES_INCREMENTOS_TOTALES);
        $paginas_informe_fichero .= dame_html_parametros_tipo_informe_fichero_sensores_incrementos_totales($parametros_informe);
        $paginas_informe_fichero .= "
                <div class='mensaje-aviso-informe-fichero' id='mensaje-aviso-informe-fichero-incrementos-totales'></div>
                <div class='fin-pagina-informe-fichero'></div>
            </div>";

        // Páginas del informe
        $paginas_informe_fichero .= dame_html_informe_tipo_sensores_incrementos_totales(TIPO_INFORME_FICHERO);
...
<script class="code" type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        sensores_incrementos_totales_ver_informe_fichero();
    });
</script>
