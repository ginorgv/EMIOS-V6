...
<body>
    <?php
        ...
        $parametros_informe = array(
            ...
            "id_sensor_hijo" => $_GET["id_sensor_hijo"],
        ...
        $contenido_informe_fichero = "
            <div id='contenedor-informe-fichero-desvios-ponderados-compra-energia' class='container contenedor-informe-fichero'>
                <div id='contenido-informe-fichero-desvios-ponderados-compra-energia'>";
        $paginas_informe_fichero = "";

        // Página de parámetros
        $paginas_informe_fichero .= "
            <div class='pagina-informe-fichero' id='pagina-parametros-informe-fichero-desvios-ponderados-compra-energia'>";
        $paginas_informe_fichero .= dame_html_cabecera_informe_fichero_smartmeter_compra_energia(TIPO_INFORME_SMARTMETER_DESVIOS_PONDERADOS_COMPRA_ENERGIA);
        $paginas_informe_fichero .= dame_html_parametros_tipo_informe_fichero_smartmeter_desvios_ponderados_compra_energia($parametros_informe);
        $paginas_informe_fichero .= "
                <div class='mensaje-aviso-informe-fichero' id='mensaje-aviso-informe-fichero-desvios-ponderados-compra-energia'></div>
                <div class='fin-pagina-informe-fichero'></div>
            </div>";

        // Páginas del informe
        $paginas_informe_fichero .= dame_html_informe_tipo_smartmeter_desvios_ponderados_compra_energia(TIPO_INFORME_FICHERO);
...
<script class="code" type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        smartmeter_desvios_ponderados_compra_energia_ver_informe_fichero();
    });
</script>
