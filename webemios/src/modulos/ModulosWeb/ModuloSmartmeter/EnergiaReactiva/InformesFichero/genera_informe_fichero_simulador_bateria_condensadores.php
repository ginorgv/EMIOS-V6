...
<body>
    <?php
        ...
        $parametros_informe = array(
            ...
            "diferencia_capacidad" => $_GET["diferencia_capacidad"],
        ...
        $contenido_informe_fichero = "
            <div id='contenedor-informe-fichero-simulador-bateria-condensadores' class='container contenedor-informe-fichero'>
                <div id='contenido-informe-fichero-simulador-bateria-condensadores'>";
        $paginas_informe_fichero = "";

        // Página de parámetros
        $paginas_informe_fichero .= "
            <div class='pagina-informe-fichero' id='pagina-parametros-informe-fichero-simulador-bateria-condensadores'>";
        $paginas_informe_fichero .= dame_html_cabecera_informe_fichero_smartmeter_energia_reactiva(TIPO_INFORME_SMARTMETER_SIMULADOR_BATERIA_CONDENSADORES);
        $paginas_informe_fichero .= dame_html_parametros_tipo_informe_fichero_smartmeter_simulador_bateria_condensadores($parametros_informe);
        $paginas_informe_fichero .= "
                <div class='mensaje-aviso-informe-fichero' id='mensaje-aviso-informe-fichero-simulador-bateria-condensadores'></div>
                <div class='fin-pagina-informe-fichero'></div>
            </div>";

        // Páginas del informe
        $paginas_informe_fichero .= dame_html_informe_tipo_smartmeter_simulador_bateria_condensadores(TIPO_INFORME_FICHERO);
...
<script class="code" type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        smartmeter_simulador_bateria_condensadores_ver_informe_fichero();
    });
</script>
