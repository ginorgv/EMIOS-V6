//
// Funciones de informes fichero de energía reactiva (de SmartMeter) (España)
//


// Genera el informe fichero de simulación de batería de condensadores
function smartmeter_simulador_bateria_condensadores_ver_informe_fichero_Espanya(parametros_informe) {
    ...
    if (error_parametros == true) {
        $('#mensaje-aviso-informe-fichero-simulador-bateria-condensadores').html(
        ...
        elimina_elemento("pagina-informe-fichero-simulador-bateria-condensadores");
        return;
    }
    ...
    function (data, status) {
        ...
        $('#titulo-informe-fichero-simulador-bateria-condensadores').html(TLNT.Idiomas._("Simulación de batería de condensadores"));
        ...
        var parametros = {
            ...
            id_contenedor_tabla_energia_reactiva_tramos: "contenedor-tabla-energia-reactiva-tramos-simulador-bateria-condensadores",
            id_grafica_consumos_energia: "grafica-consumos-energia-simulador-bateria-condensadores",
            id_grafica_coseno_phi: "grafica-coseno-phi-simulador-bateria-condensadores",
