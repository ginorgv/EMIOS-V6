...
<body>
    <?php
        ...
        $parametros_informe = array(
            ...
            "ids_sensores_reparto_costes" => $_GET["ids_sensores_reparto_costes"],
        ...
        $contenido_informe_fichero = "
            <div id='contenedor-informe-fichero-simulador-factura' class='container contenedor-informe-fichero'>
                <div id='contenido-informe-fichero-simulador-factura'>";
        $paginas_informe_fichero = "";

        // Página de parámetros
        $paginas_informe_fichero .= "
            <div class='pagina-informe-fichero' id='pagina-parametros-informe-fichero-simulador-factura'>";
        $paginas_informe_fichero .= dame_html_cabecera_informe_fichero_smartmeter_facturas(TIPO_INFORME_SMARTMETER_SIMULADOR_FACTURA);
        $paginas_informe_fichero .= dame_html_parametros_tipo_informe_fichero_smartmeter_simulador_factura($parametros_informe);
        $paginas_informe_fichero .= "
                <div class='mensaje-aviso-informe-fichero' id='mensaje-aviso-informe-fichero-simulador-factura'></div>
                <div class='fin-pagina-informe-fichero'></div>
            </div>";

        // Páginas del informe
        $medicion = $parametros_informe["medicion"];
        $paginas_informe_fichero .= dame_html_informe_tipo_smartmeter_simulador_factura($medicion, TIPO_INFORME_FICHERO);
...
<script class="code" type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        smartmeter_simulador_factura_ver_informe_fichero();
    });
</script>
