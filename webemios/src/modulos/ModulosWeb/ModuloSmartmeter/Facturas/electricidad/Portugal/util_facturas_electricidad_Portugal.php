<?php
    ...
    function dame_tabla_filtro_validaciones_facturas_electricidad_Portugal()
    {
        $idiomas = new Idiomas();
    ...
    function dame_lista_tipos_fichero_validacion_facturas_electricidad_Portugal($tipo_seleccionado)
    {
        $tipos_fichero = array();
        array_push($tipos_fichero, array(
            "id" => TIPO_NINGUNO,
            "nombre" => dame_descripcion_tipo_fichero_validacion_facturas_electricidad_Portugal(TIPO_NINGUNO)));
        array_push($tipos_fichero, array(
            "id" => TIPO_FICHERO_VALIDACION_FACTURA_ELECTRICA_ESPANYA_CIERRE_FACTURACION_ENERGY_MINUS,
            "nombre" => dame_descripcion_tipo_fichero_validacion_facturas_electricidad_Portugal(TIPO_FICHERO_VALIDACION_FACTURA_ELECTRICA_ESPANYA_CIERRE_FACTURACION_ENERGY_MINUS)));
        array_push($tipos_fichero, array(
            "id" => TIPO_FICHERO_VALIDACION_FACTURA_ELECTRICA_ESPANYA_ATR_DISTRIBUIDORA_XML,
            "nombre" => dame_descripcion_tipo_fichero_validacion_facturas_electricidad_Portugal(TIPO_FICHERO_VALIDACION_FACTURA_ELECTRICA_ESPANYA_ATR_DISTRIBUIDORA_XML)));
        array_push($tipos_fichero, array(
            "id" => TIPO_FICHERO_VALIDACION_FACTURA_ELECTRICA_ESPANYA_GEMWEB,
            "nombre" => dame_descripcion_tipo_fichero_validacion_facturas_electricidad_Portugal(TIPO_FICHERO_VALIDACION_FACTURA_ELECTRICA_ESPANYA_GEMWEB)));
    ...
    function dame_descripcion_tipo_fichero_validacion_facturas_electricidad_Portugal($tipo_fichero)
    {
        switch ($tipo_fichero)
        {
            case TIPO_NINGUNO:
