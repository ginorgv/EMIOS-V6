//
// Funciones de facturas (electricidad - Portugal)
//


// Simulación de factura
function boton_smartmeter_simulador_factura_ver_informe_electricidad_Portugal(parametros_informe) {
    ...
    function (data, status) {
        ...
        dibuja_informe_smartmeter_simulador_factura_electricidad_Portugal(
            parametros,
            resultado,
            null,
