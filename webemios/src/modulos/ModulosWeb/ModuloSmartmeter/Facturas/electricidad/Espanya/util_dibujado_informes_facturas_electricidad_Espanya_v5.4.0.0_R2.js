//
// Funciones para el dibujado de los informes de facturas (SmartMeter) (electricidad - España)
//


// Dibujado del informe de simulación de factura
function dibuja_informe_smartmeter_simulador_factura_electricidad_Espanya(
    parametros,
    datos,
    elementos_informe,
    tipo_informe) {
    ...
    var tabla_energia_activa = datos.tabla_energia_activa;
    var tabla_energia_activa_directo = datos.tabla_energia_activa_directo;
    var tabla_energia_activa_tarifa_acceso = datos.tabla_energia_activa_tarifa_acceso;
    var tabla_potencia = datos.tabla_potencia;
    var hay_datos_potencia_maxima_excesos_potencia = datos.hay_datos_potencia_maxima_excesos_potencia;
    var tabla_potencia_maxima_excesos_potencia = datos.tabla_potencia_maxima_excesos_potencia;
    var hay_datos_energia_reactiva = datos.hay_datos_energia_reactiva;
    var tabla_energia_reactiva = datos.tabla_energia_reactiva;
    ...
    var id_contenedor_tabla_energia_activa = parametros.id_contenedor_tabla_energia_activa;
    var id_contenedor_tabla_energia_activa_directo = parametros.id_contenedor_tabla_energia_activa_directo;
    var id_contenedor_tabla_energia_activa_tarifa_acceso = parametros.id_contenedor_tabla_energia_activa_tarifa_acceso;
    var id_contenedor_tabla_potencia = parametros.id_contenedor_tabla_potencia;
    var id_contenedor_tabla_potencia_maxima_excesos_potencia = parametros.id_contenedor_tabla_potencia_maxima_excesos_potencia;
    var id_contenedor_tabla_energia_reactiva = parametros.id_contenedor_tabla_energia_reactiva;
    ...
    anyade_parametros_elementos_visibles_informe_smartmeter_facturas_electricidad_Espanya(
    ...
    var mostrar_tabla_energia_activa = parametros.mostrar_tabla_energia_activa;
    var mostrar_tabla_potencia = parametros.mostrar_tabla_potencia;
    var mostrar_tabla_potencia_maxima_excesos_potencia = parametros.mostrar_tabla_potencia_maxima_excesos_potencia;
    var mostrar_tabla_energia_reactiva = parametros.mostrar_tabla_energia_reactiva;
    ...
    if (mostrar_tabla_energia_activa == true) {
        if (tabla_energia_activa !== null) {
            muestra_elemento(id_contenedor_tabla_energia_activa);
        }
        if (tabla_energia_activa_directo !== null) {
            muestra_elemento(id_contenedor_tabla_energia_activa_directo);
        }
        if (tabla_energia_activa_tarifa_acceso !== null) {
            muestra_elemento(id_contenedor_tabla_energia_activa_tarifa_acceso);
        }
    }
    if (mostrar_tabla_potencia == true) {
        muestra_elemento(id_contenedor_tabla_potencia);
    }
    if (mostrar_tabla_potencia_maxima_excesos_potencia == true) {
        muestra_elemento(id_contenedor_tabla_potencia_maxima_excesos_potencia);
    }
    if (mostrar_tabla_energia_reactiva == true) {
        muestra_elemento(id_contenedor_tabla_energia_reactiva);
    }
    ...
    if (mostrar_tabla_energia_activa == true) {
        if (tabla_energia_activa != null) {
            $("#" + id_contenedor_tabla_energia_activa).html(tabla_energia_activa);
            if (anyadir_menus_contextuales == true) {
                var id_tabla_energia_activa = anyade_id_tabla_id_contenedor_tabla(id_contenedor_tabla_energia_activa);
                var info_menu_contextual = dame_info_menu_contextual_tablas_datos();
                anyade_menu_contextual(id_tabla_energia_activa, info_menu_contextual, TLNT.Idiomas._('Energía activa'));
            }
        }
        if (tabla_energia_activa_directo != null) {
            $("#" + id_contenedor_tabla_energia_activa_directo).html(tabla_energia_activa_directo);
            if (anyadir_menus_contextuales == true) {
                var id_tabla_energia_activa_directo = anyade_id_tabla_id_contenedor_tabla(id_contenedor_tabla_energia_activa_directo);
                var info_menu_contextual = dame_info_menu_contextual_tablas_datos();
                anyade_menu_contextual(id_tabla_energia_activa_directo, info_menu_contextual, TLNT.Idiomas._('Energía activa') + " (" + TLNT.Idiomas._('consumidor directo') + ")");
            }
        }
        if (tabla_energia_activa_tarifa_acceso != null) {
            $("#" + id_contenedor_tabla_energia_activa_tarifa_acceso).html(tabla_energia_activa_tarifa_acceso);
            if (anyadir_menus_contextuales == true) {
                var id_tabla_energia_activa_tarifa_acceso = anyade_id_tabla_id_contenedor_tabla(id_contenedor_tabla_energia_activa_tarifa_acceso);
                var info_menu_contextual = dame_info_menu_contextual_tablas_datos();
                anyade_menu_contextual(id_tabla_energia_activa_tarifa_acceso, info_menu_contextual, TLNT.Idiomas._('Energía activa') + " (" + TLNT.Idiomas._('Tarifa de acceso') + ")");
            }
        }
    }
    ...
    // Tabla de potencia
    if (mostrar_tabla_potencia == true) {
        $("#" + id_contenedor_tabla_potencia).html(tabla_potencia);
        if (anyadir_menus_contextuales == true) {
            var id_tabla_potencia = anyade_id_tabla_id_contenedor_tabla(id_contenedor_tabla_potencia);
            var info_menu_contextual = dame_info_menu_contextual_tablas_datos();
            anyade_menu_contextual(id_tabla_potencia, info_menu_contextual, TLNT.Idiomas._('Potencia'));
        }
    }
    ...
    if (mostrar_tabla_potencia_maxima_excesos_potencia == true) {
        if (hay_datos_potencia_maxima_excesos_potencia == true) {
            ...
            $("#" + id_contenedor_tabla_potencia_maxima_excesos_potencia).html(tabla_potencia_maxima_excesos_potencia);
            if (anyadir_menus_contextuales == true) {
                var id_tabla_potencia_maxima_excesos_potencia = anyade_id_tabla_id_contenedor_tabla(id_contenedor_tabla_potencia_maxima_excesos_potencia);
                var info_menu_contextual = dame_info_menu_contextual_tablas_datos();
                anyade_menu_contextual(id_tabla_potencia_maxima_excesos_potencia, info_menu_contextual, TLNT.Idiomas._('Potencia máxima y excesos de potencia'));
            }
        }
        else {
            // Si hay elementos visibles se oculta el elemento, si no se muestra un mensaje de aviso
            if (hay_elementos_visibles == true) {
                oculta_elemento(id_contenedor_tabla_potencia_maxima_excesos_potencia);
            }
            else {
                cambia_clase_elemento(id_contenedor_tabla_potencia_maxima_excesos_potencia, "texto-elemento-no-mostrado-informe");
                $("#" + id_contenedor_tabla_potencia_maxima_excesos_potencia).html("<i class='icon-warning-sign color-rojo'></i> " +
                    TLNT.Idiomas._("No se muestra la tabla de potencia máxima y excesos de potencia (no hay datos)"));
            }
        }
    }
    ...
    if (mostrar_tabla_energia_reactiva == true) {
        if (hay_datos_energia_reactiva == true) {
            // Se rellena la tabla y se añade el menú contextual
            $("#" + id_contenedor_tabla_energia_reactiva).html(tabla_energia_reactiva);
            if (anyadir_menus_contextuales == true) {
                var id_tabla_energia_reactiva = anyade_id_tabla_id_contenedor_tabla(id_contenedor_tabla_energia_reactiva);
                var info_menu_contextual = dame_info_menu_contextual_tablas_datos();
                anyade_menu_contextual(id_tabla_energia_reactiva, info_menu_contextual, TLNT.Idiomas._('Energía reactiva'));
            }
        }
        else {
            // Si hay elementos visibles se oculta el elemento, si no se muestra un mensaje de aviso
            if (hay_elementos_visibles == true) {
                oculta_elemento(id_contenedor_tabla_energia_reactiva);
            }
            else {
                cambia_clase_elemento(id_contenedor_tabla_energia_reactiva, "texto-elemento-no-mostrado-informe");
                $("#" + id_contenedor_tabla_energia_reactiva).html("<i class='icon-warning-sign color-rojo'></i> " +
                    TLNT.Idiomas._("No se muestra la tabla de energía reactiva (no hay datos)"));
            }
        }
    }
...
// Añade a los parámetros los flags de elementos visibles
function anyade_parametros_elementos_visibles_informe_smartmeter_facturas_electricidad_Espanya(
    ...
    switch (tipo_informe_smartmeter_facturas) {
        case TIPO_INFORME_SMARTMETER_SIMULADOR_FACTURA: {
            ...
            var mostrar_tabla_energia_activa = true;
            var mostrar_tabla_potencia = true;
            var mostrar_tabla_potencia_maxima_excesos_potencia = true;
            var mostrar_tabla_energia_reactiva = true;
            ...
            if (elementos_informe != null) {
                if (elementos_informe.indexOf(ELEMENTO_INFORME_SMARTMETER_SIMULADOR_FACTURA_ELECTRICIDAD_ESPANYA_TITULO_DATOS) == -1) {
                    mostrar_titulo_datos = false;
                }
                if (elementos_informe.indexOf(ELEMENTO_INFORME_SMARTMETER_SIMULADOR_FACTURA_ELECTRICIDAD_ESPANYA_TABLA_DATOS) == -1) {
                    mostrar_tabla_datos = false;
                }
                if (elementos_informe.indexOf(ELEMENTO_INFORME_SMARTMETER_SIMULADOR_FACTURA_ELECTRICIDAD_ESPANYA_TITULO_RESUMEN) == -1) {
                    mostrar_titulo_resumen = false;
                }
                if (elementos_informe.indexOf(ELEMENTO_INFORME_SMARTMETER_SIMULADOR_FACTURA_ELECTRICIDAD_ESPANYA_TABLA_COSTE_CONSUMO) == -1) {
                    mostrar_tabla_coste_consumo = false;
                }
                if (elementos_informe.indexOf(ELEMENTO_INFORME_SMARTMETER_SIMULADOR_FACTURA_ELECTRICIDAD_ESPANYA_TITULO_DETALLES) == -1) {
                    mostrar_titulo_detalles = false;
                }
                if (elementos_informe.indexOf(ELEMENTO_INFORME_SMARTMETER_SIMULADOR_FACTURA_ELECTRICIDAD_ESPANYA_TABLA_ENERGIA_ACTIVA) == -1) {
                    mostrar_tabla_energia_activa = false;
                }
                if (elementos_informe.indexOf(ELEMENTO_INFORME_SMARTMETER_SIMULADOR_FACTURA_ELECTRICIDAD_ESPANYA_TABLA_POTENCIA) == -1) {
                    mostrar_tabla_potencia = false;
                }
                if (elementos_informe.indexOf(ELEMENTO_INFORME_SMARTMETER_SIMULADOR_FACTURA_ELECTRICIDAD_ESPANYA_TABLA_POTENCIA_MAXIMA_EXCESOS_POTENCIA) == -1) {
                    mostrar_tabla_potencia_maxima_excesos_potencia = false;
                }
                if (elementos_informe.indexOf(ELEMENTO_INFORME_SMARTMETER_SIMULADOR_FACTURA_ELECTRICIDAD_ESPANYA_TABLA_ENERGIA_REACTIVA) == -1) {
                    mostrar_tabla_energia_reactiva = false;
                }
                if (elementos_informe.indexOf(ELEMENTO_INFORME_SMARTMETER_SIMULADOR_FACTURA_ELECTRICIDAD_ESPANYA_TABLA_OTROS_CONCEPTOS) == -1) {
                    mostrar_tabla_otros_conceptos = false;
                }
                if (elementos_informe.indexOf(ELEMENTO_INFORME_SMARTMETER_SIMULADOR_FACTURA_ELECTRICIDAD_ESPANYA_GRAFICA_PORCENTAJES_COSTES_CONCEPTOS) == -1) {
                    mostrar_grafica_porcentajes_costes_conceptos = false;
                }
                if (elementos_informe.indexOf(ELEMENTO_INFORME_SMARTMETER_SIMULADOR_FACTURA_ELECTRICIDAD_ESPANYA_TITULO_REPARTO_COSTES) == -1) {
                ...
                if (elementos_informe.indexOf(ELEMENTO_INFORME_SMARTMETER_SIMULADOR_FACTURA_ELECTRICIDAD_ESPANYA_GRAFICA_PORCENTAJES_REPARTO_COSTES) == -1) {
            ...
            parametros.mostrar_tabla_energia_activa = mostrar_tabla_energia_activa;
            parametros.mostrar_tabla_potencia = mostrar_tabla_potencia;
            parametros.mostrar_tabla_potencia_maxima_excesos_potencia = mostrar_tabla_potencia_maxima_excesos_potencia;
            parametros.mostrar_tabla_energia_reactiva = mostrar_tabla_energia_reactiva;
            ...
            var hay_elementos_visibles =
                ...
                (mostrar_tabla_energia_activa == true) ||
                (mostrar_tabla_potencia == true) ||
                ((mostrar_tabla_potencia_maxima_excesos_potencia == true) && (hay_datos_potencia_maxima_excesos_potencia == true)) ||
                ((mostrar_tabla_energia_reactiva == true) && (hay_datos_energia_reactiva == true)) ||
...
function dibuja_elemento_plantilla_informe_smartmeter_simulador_factura_electricidad_Espanya(
    info_elemento,
    datos_elemento,
    ...
    var id_contenedor_tabla_energia_activa = prefijo_elemento + "contenedor-tabla-energia-activa-simulador-factura";
    var id_contenedor_tabla_energia_activa_directo = prefijo_elemento + "contenedor-tabla-energia-activa-directo-simulador-factura";
    var id_contenedor_tabla_energia_activa_tarifa_acceso = prefijo_elemento + "contenedor-tabla-energia-activa-tarifa-acceso-simulador-factura";
    var id_contenedor_tabla_potencia = prefijo_elemento + "contenedor-tabla-potencia-simulador-factura";
    var id_contenedor_tabla_potencia_maxima_excesos_potencia = prefijo_elemento + "contenedor-tabla-potencia-maxima-excesos-potencia-simulador-factura";
    var id_contenedor_tabla_energia_reactiva = prefijo_elemento + "contenedor-tabla-energia-reactiva-simulador-factura";
    ...
    var id_titulo_reparto_costes = prefijo_elemento + "titulo-reparto-costes-simulador-factura";
    var id_contenedor_tabla_reparto_costes = prefijo_elemento + "contenedor-tabla-reparto-costes-simulador-factura";
    var id_grafica_porcentajes_reparto_costes = prefijo_elemento + "grafica-porcentajes-reparto-costes-simulador-factura";
    ...
    var parametros = {
        ...
        id_contenedor_tabla_energia_activa: id_contenedor_tabla_energia_activa,
        id_contenedor_tabla_energia_activa_directo: id_contenedor_tabla_energia_activa_directo,
        id_contenedor_tabla_energia_activa_tarifa_acceso: id_contenedor_tabla_energia_activa_tarifa_acceso,
        id_contenedor_tabla_potencia: id_contenedor_tabla_potencia,
        id_contenedor_tabla_potencia_maxima_excesos_potencia: id_contenedor_tabla_potencia_maxima_excesos_potencia,
        id_contenedor_tabla_energia_reactiva: id_contenedor_tabla_energia_reactiva,
        ...
        id_titulo_reparto_costes: id_titulo_reparto_costes,
        id_contenedor_tabla_reparto_costes: id_contenedor_tabla_reparto_costes,
        id_grafica_porcentajes_reparto_costes: id_grafica_porcentajes_reparto_costes};
