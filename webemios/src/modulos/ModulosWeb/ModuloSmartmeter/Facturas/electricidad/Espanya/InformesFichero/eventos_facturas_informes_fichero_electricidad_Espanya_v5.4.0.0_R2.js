//
// Funciones de informes fichero de facturas (electricidad - España)
//


// Genera el informe fichero de simulación de factura
function smartmeter_simulador_factura_ver_informe_fichero_electricidad_Espanya(parametros_informe) {
