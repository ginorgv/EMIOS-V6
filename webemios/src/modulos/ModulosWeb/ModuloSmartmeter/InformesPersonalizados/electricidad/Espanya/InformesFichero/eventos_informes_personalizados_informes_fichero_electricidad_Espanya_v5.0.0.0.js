//
// Funciones de informes fichero de informes personalizados (electricidad - España)
//


// Genera el informe fichero de estudio general
function smartmeter_estudio_general_ver_informe_fichero_electricidad_Espanya(parametros_informe) {
    ...
    if (error_parametros == true) {
        ...
        elimina_elementos([
            ...
            "pagina-informe-fichero-estudio-general-resumen-consumo",
            "pagina-informe-fichero-estudio-general-analisis-coste-1",
            "pagina-informe-fichero-estudio-general-analisis-coste-2",
            "pagina-informe-fichero-estudio-general-resumen-coste",
            "pagina-informe-fichero-estudio-general-excesos-potencia",
            "pagina-informe-fichero-estudio-general-excesos-energia-reactiva",
            "pagina-informe-fichero-estudio-general-cortes-tension",
    ...
    function (data, status) {
        ...
        $('#titulo-informe-fichero-estudio-general-resumen-consumo').html(TLNT.Idiomas._("Resumen de consumo"));
        $('#titulo-informe-fichero-estudio-general-analisis-coste').html(TLNT.Idiomas._("Análisis de coste"));
        $('#titulo-informe-fichero-estudio-general-resumen-coste').html(TLNT.Idiomas._("Resumen de coste"));
        $('#titulo-informe-fichero-estudio-general-excesos-potencia').html(TLNT.Idiomas._("Excesos de potencia"));
        $('#titulo-informe-fichero-estudio-general-excesos-energia-reactiva').html(TLNT.Idiomas._("Excesos de energía reactiva"));
        $('#titulo-informe-fichero-estudio-general-cortes-tension').html(TLNT.Idiomas._("Cortes de tensión"));
