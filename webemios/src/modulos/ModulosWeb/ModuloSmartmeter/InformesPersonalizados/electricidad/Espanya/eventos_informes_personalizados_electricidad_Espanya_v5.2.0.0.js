//
// Funciones de informes personalizados (de SmartMeter) (electricidad - España)
//


// Genera y muestra el informe de estudio general
function boton_smartmeter_estudio_general_ver_informe_electricidad_Espanya(parametros_informe) {
    ...
    function (data, status) {
        ...
        dibuja_informe_smartmeter_estudio_general_electricidad_Espanya(
            parametros,
            resultado,
...
function anyade_textos_informe_estudio_general_electricidad_Espanya(apartados, textos_estudio_general) {
    ...
    var notas_resumen_consumo = $("#notas-resumen-consumo-estudio-general").val();
    var notas_analisis_coste = $("#notas-analisis-coste-estudio-general").val();
    var notas_resumen_coste = $("#notas-resumen-coste-estudio-general").val();
    var notas_excesos_potencia = $("#notas-excesos-potencia-estudio-general").val();
    var notas_excesos_energia_reactiva = $("#notas-excesos-energia-reactiva-estudio-general").val();
    var notas_cortes_tension = $("#notas-cortes-tension-estudio-general").val();
    ...
    if (notas_resumen_consumo != "") {
        if (comprueba_longitud_cadena(notas_resumen_consumo, NUMERO_MAXIMO_CARACTERES_NOTAS) == false) {
            $("#notas-resumen-consumo-estudio-general").addClass('data-check-failed');
            return (false);
        }
        textos_estudio_general["notas_resumen_consumo"] = notas_resumen_consumo;
    }
    ...
    if (notas_resumen_coste != "") {
        if (comprueba_longitud_cadena(notas_resumen_coste, NUMERO_MAXIMO_CARACTERES_NOTAS) == false) {
            $("#notas-resumen-coste-estudio-general").addClass('data-check-failed');
            return (false);
        }
        textos_estudio_general["notas_resumen_coste"] = notas_resumen_coste;
    }
    if (notas_excesos_potencia != "") {
        if (comprueba_longitud_cadena(notas_excesos_potencia, NUMERO_MAXIMO_CARACTERES_NOTAS) == false) {
            $("#notas-excesos-potencia-estudio-general").addClass('data-check-failed');
            return (false);
        }
        textos_estudio_general["notas_excesos_potencia"] = notas_excesos_potencia;
    }
    if (notas_excesos_energia_reactiva != "") {
        if (comprueba_longitud_cadena(notas_excesos_energia_reactiva, NUMERO_MAXIMO_CARACTERES_NOTAS) == false) {
            $("#notas-excesos-energia-reactiva-estudio-general").addClass('data-check-failed');
            return (false);
        }
        textos_estudio_general["notas_excesos_energia_reactiva"] = notas_excesos_energia_reactiva;
    }
    if (notas_cortes_tension != "") {
        if (comprueba_longitud_cadena(notas_cortes_tension, NUMERO_MAXIMO_CARACTERES_NOTAS) == false) {
            $("#notas-cortes-tension-estudio-general").addClass('data-check-failed');
            return (false);
        }
        textos_estudio_general["notas_cortes_tension"] = notas_cortes_tension;
    }
    ...
    if ((apartados.indexOf(APARTADO_INFORME_ESTUDIO_GENERAL_CONCLUSIONES_ELECTRICIDAD_ESPANYA) > -1) && (conclusiones == "")) {
