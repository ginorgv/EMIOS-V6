//
// Funciones de informes personalizados (de SmartMeter) (agua - España)
//


// Genera y muestra el informe de estudio general
function boton_smartmeter_estudio_general_ver_informe_agua_Espanya(parametros_informe) {
    ...
    function (data, status) {
        ...
        dibuja_informe_smartmeter_estudio_general_agua_Espanya(
            parametros,
            resultado,
...
function anyade_textos_informe_estudio_general_agua_Espanya(apartados, textos_estudio_general) {
    ...
    if ((apartados.indexOf(APARTADO_INFORME_ESTUDIO_GENERAL_CONCLUSIONES_AGUA_ESPANYA) > -1) && (conclusiones == "")) {
