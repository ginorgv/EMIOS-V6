//
// Funciones de informes fichero de informes personalizados (agua - España)
//


// Genera el informe fichero de estudio general
function smartmeter_estudio_general_ver_informe_fichero_agua_Espanya(parametros_informe) {
