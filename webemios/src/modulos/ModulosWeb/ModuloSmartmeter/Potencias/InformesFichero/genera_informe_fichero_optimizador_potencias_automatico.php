...
<body>
    <?php
        ...
        $parametros_informe = array(
            ...
            "granularidad" => $_GET["granularidad"],
            "rango_potencias" => $_GET["rango_potencias"],
            "diferencia_potencia" => $_GET["diferencia_potencia"],
        ...
        $contenido_informe_fichero = "
            <div id='contenedor-informe-fichero-optimizador-potencias-automatico' class='container contenedor-informe-fichero'>
                <div id='contenido-informe-fichero-optimizador-potencias-automatico'>";
        $paginas_informe_fichero = "";

        // Página de parámetros
        $paginas_informe_fichero .= "
            <div class='pagina-informe-fichero' id='pagina-parametros-informe-fichero-optimizador-potencias-automatico'>";
        $paginas_informe_fichero .= dame_html_cabecera_informe_fichero_smartmeter_potencias(TIPO_INFORME_SMARTMETER_OPTIMIZADOR_POTENCIAS_AUTOMATICO);
        $paginas_informe_fichero .= dame_html_parametros_tipo_informe_fichero_smartmeter_optimizador_potencias_automatico($parametros_informe);
        $paginas_informe_fichero .= "
                <div class='mensaje-aviso-informe-fichero' id='mensaje-aviso-informe-fichero-optimizador-potencias-automatico'></div>
                <div class='fin-pagina-informe-fichero'></div>
            </div>";

        // Páginas del informe
        $paginas_informe_fichero .= dame_html_informe_tipo_smartmeter_optimizador_potencias_automatico(TIPO_INFORME_FICHERO);
...
<script class="code" type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        smartmeter_optimizador_potencias_automatico_ver_informe_fichero();
    });
</script>
