<?php
    ...
    AuditoriaAcciones::comprobar_registrar_accion(ACCION_OBTENER_CONSUMOS_COSTES_SENSORES_TOTALES, $_POST);

    // Se recuperan los consumos y costes de sensores totales
    $parametros = $_POST;
    ...
    $resultado = dame_consumos_costes_sensores_totales($parametros, $filas_valores_sensores);
