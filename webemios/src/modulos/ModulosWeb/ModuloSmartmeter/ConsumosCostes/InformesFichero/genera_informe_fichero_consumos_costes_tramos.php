...
<body>
    <?php
        ...
        $contenido_informe_fichero = "
            <div id='contenedor-informe-fichero-consumos-costes-tramos' class='container contenedor-informe-fichero'>
                <div id='contenido-informe-fichero-consumos-costes-tramos'>";
        $paginas_informe_fichero = "";

        // Página de parámetros
        $paginas_informe_fichero .= "
            <div class='pagina-informe-fichero' id='pagina-parametros-informe-fichero-consumos-costes-tramos'>";
        $paginas_informe_fichero .= dame_html_cabecera_informe_fichero_smartmeter_consumos_costes(TIPO_INFORME_SMARTMETER_CONSUMOS_COSTES_TRAMOS);
        $paginas_informe_fichero .= dame_html_parametros_tipo_informe_fichero_smartmeter_consumos_costes_tramos($parametros_informe);
        $paginas_informe_fichero .= "
                <div class='mensaje-aviso-informe-fichero' id='mensaje-aviso-informe-fichero-consumos-costes-tramos'></div>
                <div class='fin-pagina-informe-fichero'></div>
            </div>";

        // Páginas del informe
        $paginas_informe_fichero .= dame_html_informe_tipo_smartmeter_consumos_costes_tramos_electricidad(TIPO_INFORME_FICHERO);
...
<script class="code" type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        smartmeter_consumos_costes_tramos_ver_informe_fichero();
    });
</script>
