...
<body>
    <?php
        ...
        $contenido_informe_fichero = "
            <div id='contenedor-informe-fichero-excesos-caudal' class='container contenedor-informe-fichero'>
                <div id='contenido-informe-fichero-excesos-caudal'>";
        $paginas_informe_fichero = "";

        // Página de parámetros
        $paginas_informe_fichero .= "
            <div class='pagina-informe-fichero' id='pagina-parametros-informe-fichero-excesos-caudal'>";
        $paginas_informe_fichero .= dame_html_cabecera_informe_fichero_smartmeter_consumos_costes(TIPO_INFORME_SMARTMETER_EXCESOS_CAUDAL);
        $paginas_informe_fichero .= dame_html_parametros_tipo_informe_fichero_smartmeter_excesos_caudal($parametros_informe);
        $paginas_informe_fichero .= "
                <div class='mensaje-aviso-informe-fichero' id='mensaje-aviso-informe-fichero-excesos-caudal'></div>
                <div class='fin-pagina-informe-fichero'></div>
            </div>";

        // Páginas del informe
        $paginas_informe_fichero .= dame_html_informe_tipo_smartmeter_excesos_caudal_gas(TIPO_INFORME_FICHERO);
...
<script class="code" type="text/javascript">
    ...
    $(document).ready(function()
    {
        ...
        smartmeter_excesos_caudal_ver_informe_fichero();
    });
</script>
