...
<body>
    <?php
        ...
        $paginas_informe_fichero .= dame_html_cabecera_informe_fichero_smartmeter_consumos_costes(TIPO_INFORME_SMARTMETER_COMPARACION_PERIODOS);
        $paginas_informe_fichero .= dame_html_parametros_tipo_informe_fichero_smartmeter_comparacion_periodos($parametros_informe);
        $paginas_informe_fichero .= "
        ...
        // Páginas del informe
        $paginas_informe_fichero .= dame_html_informe_tipo_smartmeter_comparacion_periodos(TIPO_INFORME_FICHERO);
...
<script class="code" type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        smartmeter_comparacion_periodos_ver_informe_fichero();
    });
</script>
