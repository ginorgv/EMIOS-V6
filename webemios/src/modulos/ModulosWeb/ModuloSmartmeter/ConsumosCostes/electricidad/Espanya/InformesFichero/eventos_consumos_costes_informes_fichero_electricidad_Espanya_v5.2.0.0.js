//
// Funciones de informes fichero de consumos y costes (de SmartMeter) (electricidad - España)
//


// Genera el informe fichero de excesos de potencia de un sensor (España)
function smartmeter_excesos_potencia_ver_informe_fichero_electricidad_Espanya(parametros_informe) {
    ...
    if (error_parametros == true) {
        $('#mensaje-aviso-informe-fichero-excesos-potencia').html(
        ...
        elimina_elemento("pagina-informe-fichero-excesos-potencia-excesos-potencia");
        return;
    }
    ...
    function (data, status) {
        ...
        $('#titulo-informe-fichero-excesos-potencia-excesos-potencia').html(TLNT.Idiomas._("Excesos de potencia"));
...
// Genera el informe fichero de excesos de energía reactiva de un sensor (España)
function smartmeter_excesos_energia_reactiva_ver_informe_fichero_electricidad_Espanya(parametros_informe) {
    // Se recuperan los parámetros del informe
    var error_parametros = parametros_informe["error_parametros"];
    var descripcion_error_parametros = parametros_informe["descripcion_error_parametros"];
    ...
    // Si hay error en el informe se muestra un mensaje de aviso y se eliminan las páginas del informe
    if (error_parametros == true) {
        $('#mensaje-aviso-informe-fichero-excesos-energia-reactiva').html(
            "<i class='icon-warning-sign color-rojo'></i> " + TLNT.Idiomas._("Parámetros del informe incorrectos") + " (" + descripcion_error_parametros.toLowerCase() + ")");
        elimina_elemento("pagina-informe-fichero-excesos-energia-reactiva-excesos-energia-reactiva");
        return;
    }
    ...
    function (data, status) {
        ...
        // Títulos de las páginas
        $('#titulo-informe-fichero-excesos-energia-reactiva-excesos-energia-reactiva').html(TLNT.Idiomas._("Excesos de energía reactiva"));
