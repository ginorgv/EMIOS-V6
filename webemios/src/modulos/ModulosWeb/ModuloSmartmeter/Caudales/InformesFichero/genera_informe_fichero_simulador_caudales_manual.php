...
<body>
    <?php
        ...
        $contenido_informe_fichero = "
            <div id='contenedor-informe-fichero-simulador-caudales-manual' class='container contenedor-informe-fichero'>
                <div id='contenido-informe-fichero-simulador-caudales-manual'>";
        $paginas_informe_fichero = "";

        // Página de parámetros
        $paginas_informe_fichero .= "
            <div class='pagina-informe-fichero' id='pagina-parametros-informe-fichero-simulador-caudales-manual'>";
        $paginas_informe_fichero .= dame_html_cabecera_informe_fichero_smartmeter_caudales(TIPO_INFORME_SMARTMETER_SIMULADOR_CAUDALES_MANUAL);
        $paginas_informe_fichero .= dame_html_parametros_tipo_informe_fichero_smartmeter_simulador_caudales_manual($parametros_informe);
        $paginas_informe_fichero .= "
                <div class='mensaje-aviso-informe-fichero' id='mensaje-aviso-informe-fichero-simulador-caudales-manual'></div>
                <div class='fin-pagina-informe-fichero'></div>
            </div>";

        // Páginas del informe
        $paginas_informe_fichero .= dame_html_informe_tipo_smartmeter_simulador_caudales_manual(TIPO_INFORME_FICHERO);
...
<script class="code" type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        smartmeter_simulador_caudales_manual_ver_informe_fichero();
    });
</script>
