...
<body>
    <?php
        ...
        $parametros_informe = array(
            ...
            "diferencia_caudal" => $_GET["diferencia_caudal"],
        ...
        $contenido_informe_fichero = "
            <div id='contenedor-informe-fichero-optimizador-caudales-automatico' class='container contenedor-informe-fichero'>
                <div id='contenido-informe-fichero-optimizador-caudales-automatico'>";
        $paginas_informe_fichero = "";

        // Página de parámetros
        $paginas_informe_fichero .= "
            <div class='pagina-informe-fichero' id='pagina-parametros-informe-fichero-optimizador-caudales-automatico'>";
        $paginas_informe_fichero .= dame_html_cabecera_informe_fichero_smartmeter_caudales(TIPO_INFORME_SMARTMETER_OPTIMIZADOR_CAUDALES_AUTOMATICO);
        $paginas_informe_fichero .= dame_html_parametros_tipo_informe_fichero_smartmeter_optimizador_caudales_automatico($parametros_informe);
        $paginas_informe_fichero .= "
                <div class='mensaje-aviso-informe-fichero' id='mensaje-aviso-informe-fichero-optimizador-caudales-automatico'></div>
                <div class='fin-pagina-informe-fichero'></div>
            </div>";

        // Páginas del informe
        $paginas_informe_fichero .= dame_html_informe_tipo_smartmeter_optimizador_caudales_automatico(TIPO_INFORME_FICHERO);
...
<script class="code" type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        smartmeter_optimizador_caudales_automatico_ver_informe_fichero();
    });
</script>
