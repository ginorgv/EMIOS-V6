...
function dibuja_instalacion_agua_Espanya(
    parametros,
    datos,
    tipo_informe) {
    // Datos del resultado
    var cups = datos.cups;
    var hay_informacion_tarifa_agua = datos.hay_informacion_tarifa_agua;
    if (hay_informacion_tarifa_agua == true) {
        var descripcion = datos.descripcion;
        var descripcion_tipo = datos.descripcion_tipo;
        var tabla_tramos_tarifa_agua = datos.tabla_tramos_tarifa_agua;
    }
    ...
    var id_contenedor_tabla_tramos_tarifa_agua = parametros.id_contenedor_tabla_tramos_tarifa_agua;
    ...
    if (hay_informacion_tarifa_agua == true) {
        ...
        muestra_elemento(id_contenedor_tabla_tramos_tarifa_agua);
        $("#" + id_contenedor_tabla_tramos_tarifa_agua).html(tabla_tramos_tarifa_agua);
        if (anyadir_menus_contextuales == true) {
            var id_tabla_tramos_tarifa_agua = anyade_id_tabla_id_contenedor_tabla(id_contenedor_tabla_tramos_tarifa_agua);
            var info_menu_contextual = dame_info_menu_contextual_tablas_datos();
            anyade_menu_contextual(id_tabla_tramos_tarifa_agua, info_menu_contextual, TLNT.Idiomas._('Tramos'));
        }
    }
    else {
        $("#" + id_descripcion).html(TLNT.Idiomas._("ND"));
        $("#" + id_tipo).html(TLNT.Idiomas._("ND"));
        oculta_elemento(id_contenedor_tabla_tramos_tarifa_agua);
    }
}
...
function dibuja_elemento_plantilla_informe_smartmeter_instalacion_agua_Espanya(
    info_elemento,
    datos_elemento,
    parametros_elemento,
    tipo_informe) {
    ...
    var id_contenedor_tabla_tramos_tarifa_agua = prefijo_elemento + "contenedor-tabla-tramos-tarifa-agua-instalacion";
    ...
    var parametros = {
        ...
        id_tipo: id_tipo,
        id_contenedor_tabla_tramos_tarifa_agua: id_contenedor_tabla_tramos_tarifa_agua};
