<?php
    ...
    AuditoriaAcciones::comprobar_registrar_accion(ACCION_MOSTRAR_VENTANA_MODIFICAR_TARIFAS_AGUA, $_POST);
    ...
    $pie .= '<button class="btn btn-success boton_smartmeter_modificar_tarifas_agua_Espanya">'.$idiomas->_("Modificar").'</button>';
    $pie .= '<button class="btn" data-dismiss="modal" aria-hidden="true">'.$idiomas->_("Cancelar").'</button>';

    // Se muestra el contenido de la ventana
    $titulo .= $idiomas->_("Modificar tarifas");
    $error = rellena_contenido_ventana_modificar_tarifas_agua($contenido);
    if ($error == "OK")
    {
        $res = "OK";
    }
	...
	//
	// Funcion para mostrar el contenido de la ventana de modificar tarifas de agua
	//


	// Función que rellena el contenido de la ventana de modificar tarifas de agua
	function rellena_contenido_ventana_modificar_tarifas_agua(&$contenido)
	{
        ...
        $tipo_limites_consumo_tramos = TIPO_LIMITES_CONSUMO_TRAMOS_NINGUNO;
