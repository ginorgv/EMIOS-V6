<?php
    ...
    if ($eliminar_tarifa == true)
    {
        ...
        if ($res_borrado == true)
        {
            ...
            $operacion_borrado_conceptos_adicionales_tarifa_electrica = "
                DELETE
                FROM ".TABLA_CONCEPTOS_ADICIONALES_FACTURA_TARIFAS_ELECTRICAS_PORTUGAL."
                WHERE
            ...
            anyade_accion_usuario_eliminar_tarifa_electricidad_Portugal($fila_tarifa_electrica);
    ...
    function anyade_accion_usuario_eliminar_tarifa_electricidad_Portugal($fila)
    {
