...
<body>
    <?php
        ...
        include_once($_SESSION["directorio"].'/src/modulos/ModulosWeb/ModuloSmartmeter/Autoconsumo/InformesFichero/util_autoconsumo_informes_fichero.php');
        ...
        $parametros_informe = array(
            ...
            "id_sensor_generacion" => $_GET["id_sensor_generacion"],
            "id_tarifa" => $_GET["id_tarifa"],
            "fecha_inicio" => $_GET["fecha_inicio"],
            "hora_inicio" => $_GET["hora_inicio"],
            "fecha_fin" => $_GET["fecha_fin"],
            "hora_fin" => $_GET["hora_fin"],
            "tipo_autoconsumo" => $_GET["tipo_autoconsumo"],
            "capacidad_acumulacion" => $_GET["capacidad_acumulacion"],
            "factor_multiplicacion_generacion" => $_GET["factor_multiplicacion_generacion"],
        ...
        $contenido_informe_fichero = "
            <div id='contenedor-informe-fichero-simulador-autoconsumo' class='container contenedor-informe-fichero'>
                <div id='contenido-informe-fichero-simulador-autoconsumo'>";
        $paginas_informe_fichero = "";

        // Página de parámetros
        $paginas_informe_fichero .= "
            <div class='pagina-informe-fichero' id='pagina-parametros-informe-fichero-simulador-autoconsumo'>";
        $paginas_informe_fichero .= dame_html_cabecera_informe_fichero_smartmeter_autoconsumo(TIPO_INFORME_SMARTMETER_SIMULADOR_AUTOCONSUMO);
        $paginas_informe_fichero .= dame_html_parametros_tipo_informe_fichero_smartmeter_simulador_autoconsumo($parametros_informe);
        $paginas_informe_fichero .= "
                <div class='mensaje-aviso-informe-fichero' id='mensaje-aviso-informe-fichero-simulador-autoconsumo'></div>
                <div class='fin-pagina-informe-fichero'></div>
            </div>";

        // Páginas del informe
        $paginas_informe_fichero .= dame_html_informe_tipo_smartmeter_simulador_autoconsumo(TIPO_INFORME_FICHERO);
...
<script class="code" type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        smartmeter_simulador_autoconsumo_ver_informe_fichero();
    });
</script>
