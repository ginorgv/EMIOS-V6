<?php
    ...
    // Se recuperan y devuelven los valores comprendidos entre el rango de fechas de los sensores
    $parametros = $_GET;
    $log = dame_log("api_externo");
    $log->info("Petición API HTTP: 'dame_valores_rango_fechas_sensores_api' (parámetros: '".json_encode($parametros)."')");
    $res = dame_valores_rango_fechas_sensores_api($parametros);
