<?php
    ...
    // Se recuperan y devuelven los valores comprendidos entre el rango de fechas del sensor
    $parametros = $_GET;
    $log = dame_log("api_externo");
    $log->info("Petición API HTTP: 'dame_valores_rango_fechas_sensor_api' (parámetros: '".json_encode($parametros)."')");
    $res = dame_valores_rango_fechas_sensor_api($parametros, true);
