<?php
    ...
    // Devuelve la versión de fuentes web de la red del dispositivo con la mac especificada
    $parametros = $_GET;
    $log = dame_log("api_interno");
    $log->info("Petición API HTTP: 'dame_version_fuentes_web_dispositivo_mac' (parámetros: '".json_encode($parametros)."')");
    $res = dame_version_fuentes_web_dispositivo_mac($parametros);
