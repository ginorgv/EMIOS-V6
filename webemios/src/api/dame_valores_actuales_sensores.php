<?php
    ...
    // Se recuperan y devuelven los valores actuales de los sensores
    $parametros = $_GET;
    $log = dame_log("api_externo");
    $log->info("Petición API HTTP: 'dame_valores_actuales_sensores_api' (parámetros: '".json_encode($parametros)."')");
    $res = dame_valores_actuales_sensores_api($parametros, true);
