<?php
    ...
    AuditoriaAcciones::comprobar_registrar_accion(ACCION_ENVIAR_REANUDACION_PROCESADO, $_POST);
    ...
    {
        $mqtt->publica("PROCESS/RESUME", "", 0);
        $mqtt->desconecta();

        $res = "OK";
        $msg = $idiomas->_("Petición de reanudación de procesado de datos enviada correctamente");
    }
    else
    {
        $res = "ERROR";
        $msg = $idiomas->_("No se ha podido enviar la petición de reanudación de procesado de datos");
    }
