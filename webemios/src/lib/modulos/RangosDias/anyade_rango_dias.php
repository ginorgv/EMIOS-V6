<?php
    ...
    AuditoriaAcciones::comprobar_registrar_accion(ACCION_ANYADIR_RANGO_DIAS, $_POST);
    ...
    else
    {
        ...
        if ($res_insercion == true)
        {
            ...
            $id_rango_dias = $bd_red->dame_id_autoincremental_ultima_insercion();
            $fila_rango_dias = dame_fila_rango_dias($id_rango_dias);

            // Se añade la acción de usuario
            anyade_accion_usuario_anyadir_rango_dias($fila_rango_dias);

            $res = "OK";
            $msg = $idiomas->_("Rango de días añadido correctamente");
    ...
    // Añade la acción de usuario de adición del rango de días
    function anyade_accion_usuario_anyadir_rango_dias($fila)
    {
        ...
        $tipo_accion_usuario = TIPO_ACCION_USUARIO_ANYADIR_RANGO_DIAS;
