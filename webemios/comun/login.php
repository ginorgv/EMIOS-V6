        ...
        try {
            ...
            if ($res && $res->dame_numero_filas() > 0) {
                ...
                if (crypt($contrasenya, $row['contrasenya']) === $row['contrasenya']) {
                    ...
                    $id_sesion = substr(md5($usuario . $token), 0, LONGITUD_ID_SESION);
                    header('Location: ../index.php?sesion=' . $id_sesion);
                    exit;
                }
            }
    ...
    <div id='contenedor'>
        ...
        <div id='controles-login'>
            ...
            <div class='login-footer'>
                <p>EMIOS v6.0.0.0 &copy; EnergyMinus</p>
            </div>
        </div>
    </div>
</body>
