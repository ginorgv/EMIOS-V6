...
(function($) {
    ...
    function showTooltip(plot, obj, gridpos, datapos) {
        ...
        if (gridpos[0] < (plot._width/2) && locCode.indexOf("w") !== -1) {
            loc = mirrorLocations;
        }
        else if (gridpos[0] > (plot._width/2) && locCode.indexOf("e") !== -1) {
            loc = mirrorLocations;
        }
