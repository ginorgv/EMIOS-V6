...
JustGage = function(config) {
  ...
  obj.config = {
    ...
    // weight of label showing current value
    valueFontWeight: kvLookup('valueFontWeight', config, dataset, "normal"),
    ...
    valueFontSize: kvLookup('valueFontSize', config, dataset, null),

    // unitFontSize : string
    valueUnitFontSize: kvLookup('valueUnitFontSize', config, dataset, null),
    ...
    // gaugeStroke : string
    // Border color of gauge element
    gaugeStroke: kvLookup('gaugeStroke', config, dataset, "none"),
  ...
  // Nota: Modificado el factor multiplicador (2.2) para ajustarse al tamaño del contenedor
  ...
  // Nota: Modificado para ajustarse a la altura del contenedor
  dy += (widgetH / 7);
  ...
  obj.canvas.customAttributes.pki = function(value, min, max, w, h, dx, dy, gws, reverse) {
  ...
  obj.canvas.customAttributes.ndl = function(value, min, max, w, h, dx, dy, gws) {
  ...
  if (obj.config.valueFontSize != null) {
    obj.params.valueFontSize = obj.config.valueFontSize;
  }
  if (obj.config.valueUnitFontSize != null) {
    // Nota: Tamaño de fuente para el segundo texto en la librería justgage (los textos se separan por '\n' en la cadena)
    fontSizeSecondText = obj.config.valueUnitFontSize;
  }
  obj.txtValue.attr({
    "font-size": obj.params.valueFontSize,
    "font-weight": obj.config.valueFontWeight,
  ...
  obj.txtMin.attr({
    ...
    "font-family": "Arial",
    "fill": obj.config.labelFontColor,
    "fill-opacity": obj.config.hideMinMax ? "0" : "1"
  });
